...
├── README.md            # 项目说明文档
├── ARCHITECTURE.md      # 之前的架构文档（由skill生成）
└── PROJECT-ARCHITECTURE.md # 当前架构文档
```
...
### 项目特定技能
- **project-architecture-diagram**: 生成项目架构图的skill，位于`.claude/skills/project-architecture-diagram/`
- **skill-creator**: 创建技能的指导skill，位于`.claude/skills/skill-creator/`

### 架构文档历史
- `ARCHITECTURE.md`: 先前生成的架构文档（2026-01-11）
- `PROJECT-ARCHITECTURE.md`: 当前架构文档（最新版本）
...
5. **样式层**: 作用域组件样式 + 全局样式
6. **构建层**: Vite处理开发和生产构建
7. **文档层**: CLAUDE.md指导 + 架构文档

项目展示了从传统CDN-based Vue到现代SFC-based Vue的完整迁移路径，并且集成了Claude Code技能用于架构分析和文档生成，是学习Vue.js 3组合式API和Vite构建工具的优质示例。

---

*架构文档由project-architecture-diagram skill生成，保存于2026-01-11*
*文件: PROJECT-ARCHITECTURE.md，位置: 项目根目录*
*注意: 此文件是ARCHITECTURE.md的更新版本，保留了原始架构文档*